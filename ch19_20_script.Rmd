...
model_3
newdf <- tibble(treatment = "Treated", male = c(1, 0), att_start = 9)
res_mean <- posterior_linpred(model_3, newdata = newdf)
quantile(res_mean[, 1], probs = c(0.025, 0.5, 0.975))
quantile(res_mean[, 2], probs = c(0.025, 0.5, 0.975))
res_forecast <- posterior_predict(model_3, newdata = newdf)
